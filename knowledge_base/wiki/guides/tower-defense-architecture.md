...
> **项目来源**: tower_defense 项目（未完成）

---

## 📖 文档概述

本文档详细解析塔防游戏的完整架构设计，涵盖数据模型、加密存档、异步加载、相机控制、建造系统、角色继承体系等核心模块。
...
5. [建造系统：弹出面板与类型匹配](#5-建造系统弹出面板与类型匹配)
6. [角色继承体系（攻击/受击分离）](#6-角色继承体系攻击受击分离)
7. [动态脚本挂载（运行时 set_script）](#7-动态脚本挂载运行时-set_script)
8. [Camera2D 完整控制器](#8-camera2d-完整控制器)
...
- [攻击系统设计](../concepts/attack-system.md) - 攻击/受击系统详细设计
...
- [塔防游戏案例研究](../../base/practical-experiences/case-studies/14_Tower_Defense_Case_Study.md) - 原始案例文档
